...
This repo is already configured for EAS Build APK outputs (see `eas.json` `buildType: "apk"`).

- Build an installable APK (recommended): `eas build -p android --profile preview`
- Download the latest APK to this computer: `eas build:download -p android --latest --output hrmsapp.apk`
